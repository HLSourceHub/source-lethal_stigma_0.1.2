...
Scheme
{
	...
	BaseSettings
	{
		...
		Frame.BgColor					"25 25 25 200"	[$WIN32]
		Frame.BgColor					"25 25 25 200"		[$X360]
		Frame.OutOfFocusBgColor			"50 50 50 100"	[$WIN32]
		Frame.OutOfFocusBgColor			"50 50 50 100"		[$X360]
		Frame.FocusTransitionEffectTime	"1.0"							// time it takes for a window to fade in/out on focus/out of focus
		Frame.TransitionEffectTime		"0.5"				[$WIN32]	// time it takes for a window to fade in/out on open/close
		Frame.TransitionEffectTime		"0.5"				[$X360]		// time it takes for a window to fade in/out on open/close
